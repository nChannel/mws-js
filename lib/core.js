...
(function() {
  ...
  MWS_LOCALES = {
    ...
    MX:{
      host: "mws.amazonservices.com.mx",
      country: 'Mexico',
      domain: 'www.amazon.com.mx',
      marketplaceId: MWS_MARKETPLACES.MX
    }
  };
  ...
  MWSClient = (function(_super) {
    ...
    function MWSClient() {
      ...
      this.mwsAuthToken = (_ref16 = options.mwsAuthToken) != null ? _ref16 : null;
    ...
    MWSClient.prototype.sign = function(service, q) {
      ...
      if ((_ref2 = q['mwsAuthToken']) == null){
        q['MWSAuthToken'] = this.mwsAuthToken;
      }
  ...
  MWSResponse = (function() {
    ...
    MWSResponse.prototype.parseBody = function(cb) {
      var isXml, md5, parser, _ref, _ref1,
        _this = this;
      isXml = false;
      if (this.headers['content-type'].toLowerCase() === 'text/xml') {
        this.body = this.body.toString();
        isXml = true;
      }
      if (this.headers['content-type'].toLowerCase() === 'text/xml;charset=utf-8') {
        this.body = this.body.toString();
        isXml = true;
      }
      if (this.headers['content-type'].toLowerCase() === 'text/plain') {
        this.body = this.body.toString();
