  ...
  SellersClient = (function(_super) {
    ...
    SellersClient.prototype.listMarketplaceParticipations = function(cb) {
      ...
      return this.invoke(req, opt, function(res) {
        var markets, partips;
        markets = res != null ? res.result != null ? res.result.ListMarketplaces != null ? res.result.ListMarketplaces.Marketplace : void 0 : void 0 : void 0;
        partips = res != null ? res.result != null ? res.result.ListParticipations != null ? res.result.ListParticipations.Participation : void 0 : void 0 : void 0;
        return cb({
